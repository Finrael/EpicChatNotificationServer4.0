...
router.post('/getMessages', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        ...
        axios_1.default.post(configFile_1.authenticationServer_Api_Adress + '/authenticate', {}, { headers: { cookie: req.headers.cookie } })
            ...
            return __awaiter(this, void 0, void 0, function () {
                var listOfMessages, messagesObject;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, messageSchema_1.default.find({ conversationId: req.headers.convid })];
                        case 1:
                            listOfMessages = _a.sent();
                            messagesObject = {
